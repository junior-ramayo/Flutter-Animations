...
import 'package:retos_animaciones/animations/grocery-app/pages/home/home_grocery.dart';
 ...
 class RoutesApp {
  getRoutes(){
   return {
    ...
    'home_travel': (BuildContext context) => const TravelHome(),
    'home_coffee': (BuildContext context) => const HomeCoffee(),
    'home_grocery': (BuildContext context) => const GroceryStoreHome()
   };
  }
 }
